...
public class InkBlot {
    ...
    public void generateInkBlot() {
        ...
        RandomWalk xValue = new RandomWalk(150);
        RandomWalk yValue = new RandomWalk(150);

        RandomWalk redVal = new RandomWalk(120);
        RandomWalk blueVal = new RandomWalk(130);
        RandomWalk greenVal = new RandomWalk(150);

        Line myLine;


        for (int count=0; count <15000; count++) {
            myLine = advance(xValue, yValue);
            myLine.setStrokeColor(getColor(redVal, greenVal, blueVal));

            canvas.add(myLine);
            canvas.add(mirror(myLine));
